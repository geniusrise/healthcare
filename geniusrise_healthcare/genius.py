...
#     @cherrypy.tools.json_in()
#     @cherrypy.tools.json_out()
#     def generate_summary_from_qa(self, username: Optional[str] = None, password: Optional[str] = None) -> List[Dict]:
#         if username and password:
#             self._check_auth(username=username, password=password)
#         data = cherrypy.request.json
#         snomed_concept_ids = data.get("snomed_concept_ids", [])
...
#     @cherrypy.tools.json_in()
#     @cherrypy.tools.json_out()
#     def generate_snomed_graph(self, username: Optional[str] = None, password: Optional[str] = None) -> Dict[str, Any]:
#         if username and password:
#             self._check_auth(username=username, password=password)
#         data = cherrypy.request.json
...
#         )
#         return {"graph_text": result[2], "graph_render": result[1]}
