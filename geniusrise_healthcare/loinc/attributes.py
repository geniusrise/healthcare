...
def process_attributes(attributes_file: str, G: nx.DiGraph) -> None:
    """
    Processes the LOINC attributes data and adds it to the graph.

    Args:
        attributes_file (str): Path to the LOINC attributes CSV file.
